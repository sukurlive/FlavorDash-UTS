...
export default function LoginScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (result.success) {
      Alert.alert(
        "Sukses",
        isLogin ? `Selamat datang!` : "Registrasi berhasil!",
      );
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        <Icon name="fastfood" size={60} color="#4CAF50" style={styles.logo} />
        ...
        <View style={styles.switchContainer}>
          <Text style={isLogin ? styles.activeTab : styles.inactiveTab}>
            Login
          </Text>
          <Switch
            value={!isLogin}

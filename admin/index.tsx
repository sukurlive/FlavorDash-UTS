      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={[styles.statCard, { backgroundColor: '#E8F5E9' }]}>
            <Text style={[styles.statNumber, { color: '#4CAF50' }]}>{stats.processing}</Text>
        ...
        <View style={styles.menuSection}>
          <TouchableOpacity style={styles.menuCard} onPress={() => router.push('/admin/orders')}>
            ...
            <View style={styles.menuTextContainer}>
              ...
              <Text style={styles.menuDesc}>Lihat dan update semua pesanan</Text>
            </View>
            ...
            {recentOrders.map((order: any) => (
              ...
              >
                ...
                <View style={styles.recentRight}>
                  ...
                  <Text style={styles.recentTotal}>Rp {order.total_amount.toLocaleString()}</Text>
                </View>
              </TouchableOpacity>
            ))}
          </View>
...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, minWidth: '45%', padding: 16, borderRadius: 12, alignItems: 'center', margin: 4 },
  statNumber: { fontSize: 28, fontWeight: 'bold', color: '#2196F3' },
  statLabel: { fontSize: 12, color: '#666', marginTop: 4 },
  menuSection: { padding: 16 },
  menuCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', padding: 16, borderRadius: 12, marginBottom: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 1 },
  ...
  recentItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFF', padding: 12, borderRadius: 10, marginBottom: 8 },
  recentOrderNumber: { fontSize: 14, fontWeight: 'bold', color: '#333' },
  recentUser: { fontSize: 12, color: '#888', marginTop: 2 },
  recentRight: { alignItems: 'flex-end' },
  recentTotal: { fontSize: 12, fontWeight: 'bold', color: '#4CAF50', marginTop: 4 },
